...
class Chat {
  ...
  static List<List<Chat>> dummy = [
    ...
    [
      ...
      Chat(
          name: "Developers",
          msg: "Maria: Що сталось із сервером?...",
          time: "11:35 AM",
          url: 'https://i.pravatar.cc/150?img=22',
          isRead: true),
      Chat(
          name: "Бухіч",
          msg: "You: Коли і скільки?",
          time: "08:14 PM",
    ...
    [
      ...
      Chat(
          ...
          msg: "cGl6ZGVjC...",
          time: "06:40 PM",
          url: 'https://i.pravatar.cc/150?img=35',
          isRead: true),
    ],
    // Bots
    [
      ...
      Chat(
          name: "KPI schedule",
          msg: "Вівоторок 3) Операційні системи...",
          time: "Dec 08",
          url: 'https://i.pravatar.cc/150?img=08',
          isRead: true),
    ],
  ];
}
  ...
  Drawer _buildDrawer() {
    return Drawer(
      ...
      UserAccountsDrawerHeader(
        accountName: Text('Назар Сергійчук'),
